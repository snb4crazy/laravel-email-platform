...
<div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
    @if ($messages->isEmpty())
        <p class="px-5 py-8 text-sm text-gray-400 text-center">No messages received yet.</p>
    @else
                ...
                <tbody class="divide-y divide-gray-100">
                    @foreach ($messages as $msg)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-5 py-3">
                                <a href="{{ route('messages.show', $msg) }}" class="text-indigo-600 hover:underline text-xs">View</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
